// Site Footer - Updated July 22, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "copyright svelte-i8f0ga");
			attr(div0, "class", "secondary svelte-i8f0ga");
			attr(div1, "class", "section-container svelte-i8f0ga");
		},
		m(target, anchor) {
